...
#
# This controller is for the standalone /data/fls container. It does not
# start or depend on the Termux container; use fls-t.sh for that deployment.
...
case "$1" in
    -h|--help|help)
        cat <<'EOF'
FLS-A（KernelSU / Magisk /data/fls 容器入口）
