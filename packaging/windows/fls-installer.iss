...
[Run]
Filename: "{sys}\WindowsPowerShell\v1.0\powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{tmp}\fls-payload\install.ps1"" -InstallDir ""{app}"""; StatusMsg: "正在安装 Python 环境和 FLS 依赖..."; Flags: waituntilterminated runasoriginaluser
